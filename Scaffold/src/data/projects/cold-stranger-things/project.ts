...
const project: Project = {
  ...
  tags: ["Fashion"],
  description: `
  Lacoste and Stranger Things collaborated to create a limited-edition collection of apparel and accessories inspired by the show which were featured on Hypebeast.

   Cold Archive was invited to provide cultural analysis of the impact Stranger Things has had on nerds and their social status. Lewis, the founder of Cold was featured in the article, and asked me to write the article text.
  ...
  body: `
Lacoste is gearing up to launch its latest collaboration with Netflix, seeing the label [recreate its most-celebrated shows for a full ready-to-wear collection.](https://hypebeast.com/2023/4/lacoste-netflix-collaboration-collection-release-info)

As part of the campaign, the brand has teamed up with Hypebeast to explore two of the streaming service’s most iconic series. Enlisting cultural commentator, curator, and founder of [Cold Archive](https://www.instagram.com/cold_archive/) Lewis James Dixon, the archivist delves into the cultural impact of *Stranger Things* and how references from the past continue to influence our outlook today.
...
Watch the campaign visuals with Dixon on Hypebeast’s [TikTok](https://www.tiktok.com/@hypebeast/video/7221549256879164718) now. For more information on the Netflix x Lacoste collaboration, you can visit the brand’s [website](https://www.lacoste.com/gb/).
 `
};
