...
const project: Project = {
  ...
  tags: ["AI"],
  description: `Ghostwritten technical content developed with Jason Liu to expand his thought leadership library and demonstrate expertise in AI product development. 

  Through collaborative sessions, we distilled complex concepts around data flywheels (self-reinforcing systems that leverage user interactions to continuously improve AI products) into accessible educational content.  Using examples from Netflix and Spotify, the piece illustrates how companies can transform user engagement into competitive advantages. 
  
  This article serves dual purposes: educating readers on implementing data-driven product improvement cycles while positioning Jason as an authority on practical AI applications for businesses seeking to build sustainable competitive moats.",
`,
  credits: [
    { role: "Author", name: "Joseph Gleasure" },
    { role: "Client", name: "Jason Liu" },
    { role: "URL", name: "[JXNL.co](https://jxnl.co/writing/2024/03/28/data-flywheel/)" }
  ],
...
If you're thinking about how AI can improve your business, check out my other writing on [MVPs](https://jxnl.co/writing/2024/02/18/how-to-ship-an-mvp-for-ai-applications/), [RAG Complexity](https://jxnl.co/writing/2024/02/28/levels-of-complexity-rag-applications/), and [Prompt Formatting](https://jxnl.co/writing/2024/02/20/formatting-strings/).
  `
};
